-- Complete Database Setup for Manushi Coaching Platform
...
-- Profiles - public read (avoid recursion)
CREATE POLICY "Allow public read access to profiles"
ON profiles FOR SELECT TO anon, authenticated USING (true);

-- Study materials - public read for published items
...
(
  ...
  '8.5 MB',
  'Physics Department',
  'Comprehensive collection of physics formulas for Grade 11 and 12',
  4.5,
  234,
  1450,
  ARRAY['formulas', 'reference', 'physics', 'study-guide'],
...
(
  ...
  '48.2 MB',
  'Dr. James Wilson',
  'Detailed presentation on cell structure, organelles, and cellular processes',
  4.7,
  412,
  2340,
  ARRAY['biology', 'cells', 'presentation', 'neet-prep'],
...
(
  ...
  '12.8 MB',
  'Dr. Emily Davis',
  'Complete lab manual with experiments, procedures, and safety guidelines',
  4.6,
  187,
  980,
  ARRAY['chemistry', 'lab', 'practical', 'organic'],
...
(
  ...
  '25.4 MB',
  'Dr. Sarah Johnson',
  'Advanced calculus concepts including limits, derivatives, and integrals',
  4.8,
  567,
  3120,
  ARRAY['mathematics', 'calculus', 'textbook', 'jee-advanced'],
...
(
  ...
  '15.3 MB',
  'Prof. Michael Brown',
  'Complete guide to English grammar, composition, and writing skills',
  4.4,
  298,
  1650,
  ARRAY['english', 'grammar', 'writing', 'composition'],
...
(
  ...
  '520 MB',
  'Dr. Rajesh Kumar',
  'Complete video lecture series on thermodynamics and heat transfer',
  4.9,
  892,
  5600,
  ARRAY['physics', 'thermodynamics', 'video', 'lectures'],
