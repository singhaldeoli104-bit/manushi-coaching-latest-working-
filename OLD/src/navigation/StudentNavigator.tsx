...
import ComponentTestScreen from '../screens/student/ComponentTestScreen';
...
function HomeStack() {
  ...
  return (
    <Stack.Navigator
      screenOptions={{
        headerShown: false, // Hide default header - screens use custom top bars
  ...
  return (
    ...
    >
      <Stack.Screen
        ...
        initialParams={{ classId: '457e129c-b6c5-4a09-bde5-153d7db3885a' }}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Schedule"
