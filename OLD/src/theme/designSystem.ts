...
/**
 * Status Colors
 * Semantic colors for attendance, grading, and status indicators
 * Prevents hardcoding hex colors throughout the app
 */
export const StatusColors = {
  // Success (Present, Completed, Approved)
  success: '#10B981',        // Green-500
  successBg: '#F0FDF4',      // Green-50
  successText: '#065F46',    // Green-900

  // Danger (Absent, Failed, Rejected)
  danger: '#EF4444',         // Red-500
  dangerBg: '#FEF2F2',       // Red-50
  dangerText: '#991B1B',     // Red-900

  // Warning (Late, Pending, Warning)
  ...
  infoText: '#1E40AF',       // Blue-900

  // Neutral (Unknown, Not Marked)
  neutral: '#6B7280',        // Gray-500
  neutralBg: '#F3F4F6',      // Gray-50
  neutralText: '#374151',    // Gray-900
};
...
export const Typography = {
  ...
  // MD3 Complete Typography Styles (for components expecting full style objects)
  titleLarge: {
    fontSize: 22,
    lineHeight: 28,
