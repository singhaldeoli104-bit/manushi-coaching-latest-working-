...
export const ScheduleScreen: React.FC<ScheduleScreenProps> = ({
  ...
  const renderWeekView = () => (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.weekContainer}>
      {currentWeek.map((day) => (
  ...
  const renderDayView = () => {
    ...
    if (!selectedDay) {
      return (
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.dayViewContainer}>
  ...
  const renderMonthView = () => {
    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.monthContainer}>
